...
const endpoints = [
  {
    method: 'GET',
    path: '/v1/articles',
    description: 'List & search articles with filters',
  },
  {
    method: 'GET',
    path: '/v1/articles/:id',
  ...
  },
  {
    method: 'GET',
    path: '/v1/trending',
    description: 'Get currently trending articles',
  },
  {
    method: 'GET',
    path: '/v1/categories',
            ...
            {[
              {
                ...
                desc: 'Use API keys from your dashboard to authenticate requests.',
              },
              {
                icon: Zap,
                title: 'Rate Limits',
                desc: 'Free: 100 req/day. Pro: 10k req/mo. Team: custom.',
              },
              {
                icon: BookOpen,
                title: 'Response Format',
                desc: 'All endpoints return JSON with pagination metadata.',
              },
            ].map((c) => (
              <div
                key={c.title}
